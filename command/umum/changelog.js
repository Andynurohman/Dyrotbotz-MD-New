		...
		if (q) {
			...
			await conn.sendMessage(
				msg.from,
				{
					...
					templateButtons: [
						{ urlButton: { displayText: "Shortlink", url: "https://sl.rzkyfdlh.tech/Dyrotbotz" } },
						{ urlButton: { displayText: "GC OWNER", url: "https://chat.whatsapp.com/Eqn3DKqcK2C3TWu56LBLRE" } },
						{ quickReplyButton: { displayText: "Script", id: "#sc" } },
